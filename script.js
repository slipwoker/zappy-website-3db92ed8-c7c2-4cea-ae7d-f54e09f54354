    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "The Rotmans uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '3db92ed8-c7c2-4cea-ae7d-f54e09f54354',
                    name: data.name || '',
                    email: data.email || '',
